...
### ⑧ 外星人 (Alien)
- **初始与购买：** 初始自带 买UFO权 x1。**无法使用马。** 可购买 🛸 UFO (2步)。
- **职业规则：**
  - **主动瞬移：** 只要拥有UFO，消耗 1步即可移动到地图上任意位置。**每回合限使用1次（即使拥有多个UFO也只算1次）**。
...
- **职业规则：**
  ...
  - **被动（全职高手）：** 法师只要拥有其他职业的专属道具，就可以无视职业限制使用其技能（如射箭、传送、拳套等），并在拥有对应武器时可购买专属弹药。