        ...
        return (
          <div
            ...
            className={`relative p-4 rounded-lg transition-all ${
              isDead
                ? 'bg-gray-100 dark:bg-gray-800/60 border border-gray-300 dark:border-gray-600 opacity-70'
                : isCurrentTurn
          ...
          >
            ...
            <div className="flex flex-col items-center text-center">
              ...
              {showStatus && player.isReady !== undefined && !isDead && (
              ...
              {/* 修改：公开显示健康值 & 剩余步数 */}
              {!isDead && player.health !== undefined && player.class && (
